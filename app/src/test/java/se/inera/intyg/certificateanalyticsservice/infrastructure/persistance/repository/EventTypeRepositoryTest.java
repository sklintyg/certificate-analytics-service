...
class EventTypeRepositoryTest {
  ...
  @InjectMocks private EventTypeRepository eventTypeRepository;
  @Mock private EventTypeEntityRepository eventTypeEntityRepository;
  ...
  void shouldCreateNewEventTypeEntityIfNotExists() {
    ...
    when(eventTypeEntityRepository.findByEventType(eventType.getEventType()))
